...
import BgPng2 from "../../assets/억세사리.jfif";   //   src/assets에 배경화면 넣고 경로 ../../assets/사진이름.확장자
// import BgPng3 from "../../assets/사진이름.확장자";    이거 쓰고 위에 BgPng 2줄 삭제

const backgroundStyle = {
  backgroundImage: `url(${BgPng2})`,    //BgPng3 로 바꾸셈   흰색 배경은 추천안함
