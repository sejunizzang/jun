...
import HeroPng from "../../assets/Ring_Banner.png";

const Hero = () => {
  return (
    <>
      <div className="min-h-[550px] sm:min-h-[600px] bg-brandDark flex justify-center items-center text-black">
        <div className="container pb-8 sm:pb-0">
          <div className="grid grid-cols-1 sm:grid-cols-2">
            ...
            >
              ...
              >
                <h1 className="text-white">This years.</h1>
              </div>
              <div
                data-aos="fade-right"
                data-aos-offset="0"
              ...
              >
                <h1 className="text-white">Best Ring.</h1>
              </div>
            </div>
          </div>
        </div>
