...
import Logo from "../../assets/website/Ring_logo.png";
import { FaCoffee,FaRing } from "react-icons/fa";
          ...
          <div className="flex justify-between items-center">
            ...
            >
              ...
              <button className=" bg-primary/70 hover:scale-105 duration-200 text-white px-4 py-2 rounded-full flex items-center gap-3">
                Order
                <FaRing className="text-xl text-white drop-shadow-sm cursor-pointer" />
              </button>
            </div>
          </div>
        </div>
